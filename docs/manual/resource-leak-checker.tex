...
A reference to a owning collection may be re-assigned any number of times.
...
\subsubsectionAndLabel{Assignment of resource-holding collections}{resource-leak-collections-assignment}
