...
public final class TreeUtils {
  ...
  //  * code.
  //  *
  //  * <p>Note that there are trees that may actually start at position 0 in the source code, such
  // as
  ...
  //   System.out.println("jctree startpos: " + ((JCTree) tree).getStartPosition());
